...
/**
 * 
 * This is a custom tag that renders a compiled web resource based on a path to a 
 * web resource source file.
 * 
 * @author bpaulin
 *
 */
public class WebResourceTag extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        try {
            ...
            {
                String javaScript = webResourceScriptCache.getCompiledScript(currentNode.getSession(), currentPath);
