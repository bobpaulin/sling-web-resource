...
public class WebResourceScriptCacheImplTest {
    ...
    @Test
    public void testGetCachedCompiledScriptPathGroupCachePath() throws Exception {
        ...
        String result = webResourceScriptCache.getCachedCompiledScriptPath(mockNode, webResrouceGroup, mockScriptCompiler);
        
        assertEquals("Cache Path should be overriden", "/test/cache/path/test.js", result);
    ...
    @Test
    public void testGetCachedCompiledScriptPathGroupNoOverride() throws Exception {
        ...
        assertEquals("Cache Path should be group default", "/var/webresource/groups/test.js", result);
    ...
    public void testGetCachedCompiledScriptPathPathBased() throws Exception {
        ...
        String result = webResourceScriptCache.getCachedCompiledScriptPath(mockNode, null, mockScriptCompiler);
        
        assertEquals("Cache Path should be compiler default", "/compile/cache/test/path/test.js", result);
    ...
    public void testIsCacheFresh() throws Exception {
        ...
        expect(mockCacheNode.getNode(Property.JCR_CONTENT)).andReturn(mockCacheNode);
        expect(mockSourceNode.getNode(Property.JCR_CONTENT)).andReturn(mockSourceNode);
        expect(mockCacheNode.getProperty(Property.JCR_LAST_MODIFIED)).andReturn(mockCacheProperty);
        expect(mockSourceNode.getProperty(Property.JCR_LAST_MODIFIED)).andReturn(mockSourceProperty);
        ...
        boolean result = webResourceScriptCache.isCacheFresh(mockCacheNode, mockSourceNode);
